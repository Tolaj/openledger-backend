...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .dir-badge { display: inline-block; margin-top: 4px; background: ${isIncome ? "#dbeafe" : "#fef3c7"}; color: ${isIncome ? "#1e40af" : "#92400e"}; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 4px; }
