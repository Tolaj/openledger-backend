...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .so-number { font-size: 20px; font-weight: 700; color: #09090b; font-variant-numeric: tabular-nums; }
  .so-date { font-size: 11px; color: #71717a; margin-top: 4px; }
  .status-badge { display: inline-block; margin-top: 6px; background: #f4f4f5; color: #52525b; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 4px; }
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="so-meta">
      <div class="so-number">${so.soNumber}</div>
      <div class="so-date">Issued ${createdDate}</div>
