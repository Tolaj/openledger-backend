export const renderGOHtml = (go, group) => {
    ...
    const directionLabel = isPayable ? "Purchase Order" : "Sales Order";
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .go-meta { text-align: right; }
  .go-number { font-size: 20px; font-weight: 700; color: #09090b; font-variant-numeric: tabular-nums; }
  .go-date { font-size: 11px; color: #71717a; margin-top: 4px; }
  ...
  .dir-badge { display: inline-block; margin-top: 4px; background: ${isPayable ? "#fef3c7" : "#dbeafe"}; color: ${isPayable ? "#92400e" : "#1e40af"}; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; padding: 3px 8px; border-radius: 4px; }
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="go-meta">
      <div class="go-number">${go.goNumber}</div>
      <div class="go-date">Issued ${createdDate}</div>
