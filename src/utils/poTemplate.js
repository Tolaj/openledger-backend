...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .po-number { font-size: 20px; font-weight: 700; color: #09090b; font-variant-numeric: tabular-nums; }
  .po-date { font-size: 11px; color: #71717a; margin-top: 4px; }
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="po-meta">
      ...
      <div class="po-date">Issued ${createdDate}</div>
